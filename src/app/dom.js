...
export function queryAppDom(documentRef = document) {
  return {
    ...
    seesoLicenseKeyInput: getRequiredElement(documentRef, '#seesoLicenseKeyInput'),
    ...
    cloudAoiMaxPointsInput: getRequiredElement(documentRef, '#cloudAoiMaxPointsInput'),
    cloudAoiSimplifyInput: getRequiredElement(documentRef, '#cloudAoiSimplifyInput'),
    ...
    participantGazeSetup: getRequiredElement(documentRef, '#participantGazeSetup'),
    participantGazeProviderSelect: getRequiredElement(documentRef, '#participantGazeProviderSelect'),
    participantSeeSoLicenseKeyInput: getRequiredElement(documentRef, '#participantSeeSoLicenseKeyInput'),
    participantGazeSetupStatus: getRequiredElement(documentRef, '#participantGazeSetupStatus'),
    ...
    validationTestKeyInput: getRequiredElement(documentRef, '#validationTestKeyInput'),
    validationTestCalibrateButton: getRequiredElement(documentRef, '#validationTestCalibrateButton'),
    validationTestBlankButton: getRequiredElement(documentRef, '#validationTestBlankButton'),
