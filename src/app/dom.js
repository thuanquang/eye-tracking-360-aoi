...
export function queryAppDom(documentRef = document) {
  return {
    ...
    exportCompressedButton: getRequiredElement(documentRef, '#exportCompressedButton'),
    ...
    analyticsExportCompressedButton: getRequiredElement(documentRef, '#analyticsExportCompressedButton'),
    ...
    participantExportJsonGzipButton: getRequiredElement(documentRef, '#participantExportJsonGzipButton'),
